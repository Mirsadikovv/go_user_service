...
type OrderStatusServiceClient interface {
	...
	GetStatusByID(ctx context.Context, in *OrderPrimaryStatusKeyRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error)
}
...
func (c *orderStatusServiceClient) Create(ctx context.Context, in *CreateStatusRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/orderstatus.OrderStatusService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderStatusServiceClient) GetByID(ctx context.Context, in *OrderPrimaryKeyRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	out := new(GetOrderStatusResponse)
	err := c.cc.Invoke(ctx, "/orderstatus.OrderStatusService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderStatusServiceClient) PUTCH(ctx context.Context, in *OrderPrimaryStatusKeyRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	out := new(GetOrderStatusResponse)
	err := c.cc.Invoke(ctx, "/orderstatus.OrderStatusService/PUTCH", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderStatusServiceClient) GetStatusByID(ctx context.Context, in *OrderPrimaryStatusKeyRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	out := new(GetOrderStatusResponse)
	err := c.cc.Invoke(ctx, "/orderstatus.OrderStatusService/GetStatusByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderStatusServiceServer interface {
	...
	GetStatusByID(context.Context, *OrderPrimaryStatusKeyRequest) (*GetOrderStatusResponse, error)
}
...
func (UnimplementedOrderStatusServiceServer) GetStatusByID(context.Context, *OrderPrimaryStatusKeyRequest) (*GetOrderStatusResponse, error) {
...
func _OrderStatusService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderstatus.OrderStatusService/Create",
	}
...
func _OrderStatusService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderstatus.OrderStatusService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrderStatusService_PUTCH_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderstatus.OrderStatusService/PUTCH",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrderStatusService_GetStatusByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderPrimaryStatusKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderStatusServiceServer).GetStatusByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderstatus.OrderStatusService/GetStatusByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderStatusServiceServer).GetStatusByID(ctx, req.(*OrderPrimaryStatusKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderStatusService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderStatusService_GetStatusByID_Handler,
		},
	},
