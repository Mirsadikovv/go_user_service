...
type ShopServiceClient interface {
	...
	Delete(ctx context.Context, in *ShopPrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *shopServiceClient) Create(ctx context.Context, in *CreateShop, opts ...grpc.CallOption) (*Shop, error) {
	out := new(Shop)
	err := c.cc.Invoke(ctx, "/user_service.ShopService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) GetByID(ctx context.Context, in *ShopPrimaryKey, opts ...grpc.CallOption) (*Shop, error) {
	out := new(Shop)
	err := c.cc.Invoke(ctx, "/user_service.ShopService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) GetList(ctx context.Context, in *GetListShopRequest, opts ...grpc.CallOption) (*GetListShopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.ShopService/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) Update(ctx context.Context, in *UpdateShop, opts ...grpc.CallOption) (*Shop, error) {
	out := new(Shop)
	err := c.cc.Invoke(ctx, "/user_service.ShopService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) Delete(ctx context.Context, in *ShopPrimaryKey, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/user_service.ShopService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShopServiceServer interface {
	...
	Delete(context.Context, *ShopPrimaryKey) (*empty.Empty, error)
}
...
func (UnimplementedShopServiceServer) Delete(context.Context, *ShopPrimaryKey) (*empty.Empty, error) {
...
func _ShopService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.ShopService/Create",
	}
...
func _ShopService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.ShopService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.ShopService/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.ShopService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.ShopService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
