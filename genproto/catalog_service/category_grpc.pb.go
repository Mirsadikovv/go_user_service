...
func (c *categoryServiceClient) Create(ctx context.Context, in *CreateCategory, opts ...grpc.CallOption) (*GetCategory, error) {
	out := new(GetCategory)
	err := c.cc.Invoke(ctx, "/catalog_service_go.CategoryService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) GetByID(ctx context.Context, in *CategoryPrimaryKey, opts ...grpc.CallOption) (*GetCategory, error) {
	out := new(GetCategory)
	err := c.cc.Invoke(ctx, "/catalog_service_go.CategoryService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) GetList(ctx context.Context, in *GetListCategoryRequest, opts ...grpc.CallOption) (*GetListCategoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/catalog_service_go.CategoryService/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) Update(ctx context.Context, in *UpdateCategory, opts ...grpc.CallOption) (*GetCategory, error) {
	out := new(GetCategory)
	err := c.cc.Invoke(ctx, "/catalog_service_go.CategoryService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CategoryService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog_service_go.CategoryService/Create",
	}
...
func _CategoryService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog_service_go.CategoryService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CategoryService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog_service_go.CategoryService/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CategoryService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog_service_go.CategoryService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CategoryService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/catalog_service_go.CategoryService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
